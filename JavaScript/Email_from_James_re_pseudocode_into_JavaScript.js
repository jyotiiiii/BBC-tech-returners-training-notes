...
Reviewing that we can see the following // we want to loop through whole catalogue, starting at the beginning and checking one at a time, until we find the particular titleAnd Rebecca has correctly identified that the best way of going through a collection (array) of things is with a loop
